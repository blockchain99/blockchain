...
public class Crypto {
	...
	// To verify a signature, you will use the verifySignature() 
	//This method takes a public key, a message and a signature, and returns true 
	//if and only signature correctly verifies over message with the public key pubKey.
